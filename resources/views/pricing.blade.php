    ...
    <!-- Pricing -->
    <div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto" id="pricing">
        <!-- Title -->
        <div class="max-w-2xl mx-auto text-center mb-10 lg:mb-14">
            <h2 class="text-2xl font-bold md:text-4xl md:leading-tight dark:text-white">Subscription Plan</h2>
        ...
        <div class="mt-12 grid place-items-center gap-6">
            <!-- Card -->
            <div class="flex flex-col border border-gray-200 text-center rounded-xl p-8 dark:border-gray-700">
                ...
                <span class="mt-3 font-bold text-5xl text-gray-800 dark:text-gray-200">
                    <span class="font-bold text-3xl -me-2">₹</span>
                    20
                </span>
                <p class="mt-2 text-sm text-gray-500">Just for keeping the platform running.</p>
            ...
            {{-- <div
                ...
                <p class="mb-3"><span
                        ...
                        popular</span></p>
                <h4 class="font-medium text-lg text-gray-800 dark:text-gray-200">Half</h4>
