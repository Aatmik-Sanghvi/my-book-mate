                                                            ...
                                                            <table width="100%" cellpadding="0" cellspacing="0"
                                                                ...
                                                                <tr>
                                                                    <td class="v-text-align"
                                                                        ...
                                                                        align="center">
                                                                        <a href="tps://linen-alligator-682424.hostingersite.com"
                                                                            target="_blank">
                                                                            <img align="center" border="0"
                                                                                src="{{ asset('assets/images/image-5.png') }}"
                                                                                alt="image" title="image"
                                                                                style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;height: auto;float: none;width: 17%;max-width: 102px;"
                                                                                width="102" />
                                                                        </a>
                                                                    </td>
                                                                </tr>
                                        ...
                                        <div
                                                    ...
                                                    <tr>
                                                        <td class="v-container-padding-padding"
                                                            ...
                                                            <h1 class="v-text-align v-font-size"
                                                                style="margin: 0px; color: #026324; line-height: 140%; text-align: center; word-wrap: break-word; font-family: comic sans ms,sans-serif; font-size: 22px; font-weight: 400;">
                                            ...
                                            <table id="u_content_text_11"
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td class="v-container-padding-padding"
                                                            style="overflow-wrap:break-word;word-break:break-word;padding:30px 65px;font-family:arial,helvetica,sans-serif;"
                                                            align="left">

                                                            <div class="v-text-align v-font-size"
                                                                style="font-family: comic sans ms,sans-serif; font-size: 14px; color: #026324; line-height: 140%; text-align: left; word-wrap: break-word;">
                                                                <p style="line-height: 140%;">Hi
                                                                    {{ $bookOwner->name }},</p>
                                                                <p style="line-height: 140%;">{{ $requestMessage }}</p>
                                                            </div>
                                        ...
                                        <div
                                            ...
                                            <table id="u_content_heading_2"
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td class="v-container-padding-padding"
                                                            style="overflow-wrap:break-word;word-break:break-word;padding:10px 10px 10px 65px;font-family:arial,helvetica,sans-serif;"
                                                            align="left">

                                                            <!--[if mso]><table width="100%"><tr><td><![endif]-->
                                                            <h1 class="v-text-align v-font-size"
                                                                style="margin: 0px; color: #026324; line-height: 140%; text-align: left; word-wrap: break-word; font-size: 12px; font-weight: 700;">
                                                    ...
                                                    <tr>
                                                        <td class="v-container-padding-padding"
                                                            ...
                                                            <h1 class="v-text-align v-font-size"
                                                                ...
                                                                <span><span><span
                                                                            data-metadata="&lt;!--(figmeta)eyJmaWxlS2V5IjoiaUdkbDhwdlZkTlBQU2x2aTlkeXpHRyIsInBhc3RlSUQiOjIwMjM3MDI2MTAsImRhdGFUeXBlIjoic2NlbmUifQo=(/figmeta)--&gt;"></span>Thanks
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td class="v-container-padding-padding"
                                                            ...
                                                            <table height="0px" align="center" border="0"
                                                                cellpadding="0" cellspacing="0" width="92%"
